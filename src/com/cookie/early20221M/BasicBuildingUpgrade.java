...
/**
 * Upgrades that simply double the efficiency of a building.
 */
public enum BasicBuildingUpgrade implements ProductionUpgrade {
   ...
   */
  BasicBuildingUpgrade(BuildingType target, long targetMinimum, double price) {
    this.target = target;
